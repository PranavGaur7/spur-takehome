...
Once the app is running, try these specific test cases to verify the agent's logic and constraints:
...
*   **Prompting:** Used a strict System Prompt seeding the agent with "SpurMart" domain knowledge (shipping, returns, hours) and explicit behavioral guardrails.
*   **Safety & Cost:** 
    * Limits generation to `maxOutputTokens: 150` to prevent infinite generation costs.
